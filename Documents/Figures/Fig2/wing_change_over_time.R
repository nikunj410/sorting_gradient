...
set.seed(234)
img = readPNG("Documents/Figures/Fig2/storm.png",native = TRUE)
...
# cairo_pdf("Documents/Figures/fig2/output.pdf")
# Male plot
...
plot(p_male)
# dev.off()
ggsave("Documents/Figures/fig2/selection.pdf",p_male, width = 9, height = 8 , units = c("cm"))
