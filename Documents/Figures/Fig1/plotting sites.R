...
img_unflooded = readJPEG("Documents/Figures/Fig1/unflooded.jpg",native = TRUE)
img_flooded = readJPEG("Documents/Figures/Fig1/flooded.jpg",native = TRUE)
img_bug = readPNG("Documents/Figures/Fig1/bug.png",native = TRUE)
...
ggsave("Documents/Figures/fig1/sites.pdf",Fig1, width = 18, height = 10.9 , units = c("cm"))
